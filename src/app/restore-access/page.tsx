...
export default function RestoreAccessPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      setDone(true);
      setTimeout(() => router.push('/college-predictor'), 1200);
    } catch {
  ...
  return (
    <div className="container-page max-w-md py-12">
      <h1 className="font-display text-display-lg font-semibold text-ink">Restore my access</h1>
      ...
      {done ? (
        <div className="mt-6 rounded-card bg-good-tint px-4 py-4 text-sm text-good">
